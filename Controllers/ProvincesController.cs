...
namespace lab2.Controllers
{
    public class ProvincesController : Controller
    {
        ...
        {
            return View(await _context.ProvincesDbset.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var province = await _context.ProvincesDbset
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var province = await _context.ProvincesDbset.FindAsync(id);
            if (province == null)
            {
                return NotFound();
            }
        ...
        {
            var province = await _context.ProvincesDbset.FindAsync(id);
            _context.ProvincesDbset.Remove(province);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.ProvincesDbset.Any(e => e.ProvinceCode == id);
        }
    }
}
